...
> **무슨 주제인가:** 팰월드 1.0의 거점 작업 강화 특성·파트너 스킬을 찾는 도구다.<br>
> **무엇이 불편했나:** 원하는 효과는 알아도 어떤 특성·파트너 스킬·팰이 그 효과를 주는지 게임 안에서 역으로 찾기 어렵다.<br>
> **그래서 무엇을 만들었나:** 작업 종류와 효과 조건을 고르면 현재 PC의 게임 데이터에서 맞는 특성·파트너 스킬·팰을 찾아주는 로컬 웹앱을 만들었다.
