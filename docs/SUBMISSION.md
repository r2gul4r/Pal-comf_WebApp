...
과제 안내 원문 기준 제출 주소는 `juran03@sortech.co.kr`이며 제출 기한은
지원자에게 전달된 메일 안내를 다시 확인한다.
...
```text
[소르테크 사전 과제 제출] 과제 A - Pal-comf WebApp - [이름]
```
...
```text
안녕하세요.
소르테크 개발자 채용 사전 과제 A를 제출드립니다.

무슨 주제인가:
팰월드 1.0에서 거점 작업을 강화하는 패시브·파트너 스킬·팰을 역검색하는 도구입니다.

무엇이 불편했나:
정식 버전에 새 패시브와 스킬이 추가됐지만 인게임 검색이 없고,
기존 DB는 팰을 하나씩 열어봐야 필요한 효과를 찾을 수 있었습니다.

그래서 무엇을 만들었나:
작업 또는 패시브 키워드 하나로 관련 팰·효과·수치를 바로 찾는
로컬 웹앱을 만들었습니다.
